...
!function (t, e) {
    ...
    e.extend = function (t) {
        ...
        var i, n = e.__super__ = this.prototype, o = N(n);
    ...
    var _t = document.documentElement.style, pt = "ActiveXObject" in window, mt = pt && !document.addEventListener,
        o = "msLaunchUri" in navigator && !("documentMode" in document), ft = Wt("webkit"), gt = Wt("android"),
        vt = Wt("android 2") || Wt("android 3"), yt = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
        yt = gt && Wt("Google") && yt < 537 && !("AudioNode" in window), xt = !!window.opera, wt = !o && Wt("chrome"),
        bt = Wt("gecko") && !ft && !xt && !pt, Pt = !wt && Wt("safari"), Lt = Wt("phantom"), y = "OTransition" in _t,
        Tt = 0 === navigator.platform.indexOf("Win"), Mt = pt && "transition" in _t,
        zt = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix && !vt, _t = "MozPerspective" in _t,
        Ct = !window.L_DISABLE_3D && (Mt || zt || _t) && !y && !Lt,
        Zt = "undefined" != typeof orientation || Wt("mobile"), St = Zt && ft, Et = Zt && zt,
        kt = !window.PointerEvent && window.MSPointerEvent, Ot = !(!window.PointerEvent && !kt),
        Bt = "ontouchstart" in window || !!window.TouchEvent, At = !window.L_NO_TOUCH && (Bt || Ot), It = Zt && xt,
    ...
    var b = {
        ...
        }, Ut = b.msPointer ? "MSPointerDown" : "pointerdown", Vt = b.msPointer ? "MSPointerMove" : "pointermove",
        Gt = b.msPointer ? "MSPointerUp" : "pointerup", qt = b.msPointer ? "MSPointerCancel" : "pointercancel",
        Kt = {touchstart: Ut, touchmove: Vt, touchend: Gt, touchcancel: qt}, Yt = {
            touchstart: function (t, e) {
                e.MSPOINTER_TYPE_TOUCH && e.pointerType === e.MSPOINTER_TYPE_TOUCH && k(e);
                ie(t, e)
            }, touchmove: ie, touchend: ie, touchcancel: ie
        }, Jt = {}, Xt = !1;
    ...
    var Oe = {mouseenter: "mouseover", mouseleave: "mouseout", wheel: !("onwheel" in window) && "mousewheel"};

    function Be(e, t, i, n) {
        var o, s, r = t + h(i) + (n ? "_" + h(n) : "");
        e[Ee] && e[Ee][r] || (s = o = function (t) {
            return i.call(n || e, t || window.event)
        }, !b.touchNative && b.pointer && 0 === t.indexOf("touch") ? o = $t(e, t, o) : b.touch && "dblclick" === t ? o = oe(e, o) : "addEventListener" in e ? "touchstart" === t || "touchmove" === t || "wheel" === t || "mousewheel" === t ? e.addEventListener(Oe[t] || t, o, !!b.passiveEvents && {passive: !1}) : "mouseenter" === t || "mouseleave" === t ? e.addEventListener(Oe[t], o = function (t) {
    ...
    var mt = {
        ...
        _createAnimProxy: function () {
            ...
            this._panes.mapPane.appendChild(t), this.on("zoomanim", function (t) {
                var e = ce, i = this._proxy.style[e];
    ...
    }), Xe = (O.mergeOptions({zoomControl: !0}), O.addInitHook(function () {
    ...
    }), o = (O.mergeOptions({attributionControl: !0}), O.addInitHook(function () {
    ...
    }, {Events: n}), Qe = b.touch ? "touchstart mousedown" : "mousedown", ti = it.extend({
    ...
    function ni(t, e, i, n, o) {
        var s, r, a, h = n ? Ke : si(t, i), l = si(e, i);
        for (Ke = l; ;) {
            if (!(h | l)) return [t, e];
            if (h & l) return !1;
    ...
    var vt = {__proto__: null, clipPolygon: li, polygonCenter: ui}, yt = {
            project: function (t) {
        ...
        }), _i = l({}, st, {code: "EPSG:4326", projection: yt, transformation: ht(1 / 180, 1, -1 / 180, .5)}),
        Lt = l({}, ot, {
        ...
        y = (ot.Earth = st, ot.EPSG3395 = Pt, ot.EPSG3857 = lt, ot.EPSG900913 = ut, ot.EPSG4326 = _i, ot.Simple = Lt, it.extend({
            ...
            addLayer: function (t) {
                return this.hasLayer(t) ? this : (t.addEventParent(this), pi.prototype.addLayer.call(this, t), this.fire("layeradd", {layer: t}))
            }, removeLayer: function (t) {
                return this.hasLayer(t) ? ((t = t in this._layers ? this._layers[t] : t).removeEventParent(this), pi.prototype.removeLayer.call(this, t), this.fire("layerremove", {layer: t})) : this
            }, setStyle: function (t) {
    ...
    var vi = fi.extend({
        ...
        initialize: function (t) {
            ...
            var e = this._marker, i = e._map, n = this._marker.options.autoPanSpeed,
                o = this._marker.options.autoPanPadding, s = Le(e._icon), r = i.getPixelBounds(),
            ...
            var e = this._marker, i = e._shadow, n = Le(e._icon), o = e._map.layerPointToLatLng(n);
    ...
    var Ti = Pi.extend({
        ...
        }, setStyle: bi.prototype.setStyle, _project: function () {
    ...
    var Zi = zi.extend({
        options: {fill: !0}, isEmpty: function () {
            ...
            var t = zi.prototype._convertLatLngs.call(this, t), e = t.length;
    ...
    function ki(t, e) {
        var i, n, o, s, r = "Feature" === t.type ? t.geometry : t, a = r ? r.coordinates : null, h = [],
            l = e && e.pointToLayer, u = e && e.coordsToLatLng || Bi;
        if (!a && !r) return null;
        switch (r.type) {
            case"Point":
            ...
            case"GeometryCollection":
                for (o = 0, s = r.geometries.length; o < s; o++) {
                    var c = ki({geometry: r.geometries[o], type: "Feature", properties: t.properties}, e);
                    c && h.push(c)
                }
                return new mi(h);
    ...
    Tt = {
        toGeoJSON: function (t) {
            return Ni(this, {type: "Point", coordinates: Ii(this.getLatLng(), t)})
        }
    };
    ...
    xi.include(Tt), Ti.include(Tt), Pi.include(Tt), zi.include({
        toGeoJSON: function (t) {
            ...
            return Ni(this, {type: (e ? "Multi" : "") + "LineString", coordinates: Ri(this._latlngs, e ? 1 : 0, !1, t)})
        }
    }), Zi.include({
        toGeoJSON: function (t) {
            var e = !A(this._latlngs), i = e && !A(this._latlngs[0]), t = Ri(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
            return Ni(this, {type: (i ? "Multi" : "") + "Polygon", coordinates: t = e ? t : [t]})
        }
    }), pi.include({
        toMultiPoint: function (e) {
            ...
            }), i ? Ni(this, {geometries: n, type: "GeometryCollection"}) : {type: "FeatureCollection", features: n})
        }
    });
    ...
    var I = y.extend({
        ...
        options: {
            ...
            I.prototype.onAdd.call(this, t), t.fire("popupopen", {popup: this}), this._source && (this._source.fire("popupopen", {popup: this}, !0), this._source instanceof bi || this._source.on("preclick", Ie))
        }, onRemove: function (t) {
            I.prototype.onRemove.call(this, t), t.fire("popupclose", {popup: this}), this._source && (this._source.fire("popupclose", {popup: this}, !0), this._source instanceof bi || this._source.off("preclick", Ie))
        }, getEvents: function () {
            ...
            var e, i, n, o, s, r, a, h;
            this.options.autoPan && (this._map._panAnim && this._map._panAnim.stop(), e = this._map, i = parseInt(me(this._container, "marginBottom"), 10) || 0, i = this._container.offsetHeight + i, h = this._containerWidth, (n = new p(this._containerLeft, -i - this._containerBottom))._add(Le(this._container)), n = e.layerPointToContainerPoint(n), s = m(this.options.autoPanPadding), o = m(this.options.autoPanPaddingTopLeft || s), s = m(this.options.autoPanPaddingBottomRight || s), r = e.getSize(), a = 0, n.x + h + s.x > r.x && (a = n.x + h - r.x + s.x), n.x - a - o.x < (h = 0) && (a = n.x - o.x), n.y + i + s.y > r.y && (h = n.y + i - r.y + s.y), n.y - h - o.y < 0 && (h = n.y - o.y), (a || h) && e.fire("autopanstart").panBy([a, h], {animate: t && "moveend" === t.type}))
        }, _getAnchor: function () {
            return m(this._source && this._source._getPopupAnchor ? this._source._getPopupAnchor() : [0, 0])
        }
    })), Ji = (O.mergeOptions({closePopupOnClick: !0}), O.include({
        ...
        onAdd: function (t) {
            I.prototype.onAdd.call(this, t), this.setOpacity(this.options.opacity), t.fire("tooltipopen", {tooltip: this}), this._source && (this.addEventParent(this._source), this._source.fire("tooltipopen", {tooltip: this}, !0))
        },
        onRemove: function (t) {
            I.prototype.onRemove.call(this, t), t.fire("tooltipclose", {tooltip: this}), this._source && (this.removeEventParent(this._source), this._source.fire("tooltipclose", {tooltip: this}, !0))
        },
        getEvents: function () {
            var t = I.prototype.getEvents.call(this);
    ...
    un.create = ln, un.pointsToPath = dt, Ei.geometryToLayer = ki, Ei.coordsToLatLng = Bi, Ei.coordsToLatLngs = Ai, Ei.latLngToCoords = Ii, Ei.latLngsToCoords = Ri, Ei.getFeature = Ni, Ei.asFeature = Di, O.mergeOptions({boxZoom: !0});
    _t = o.extend({
        initialize: function (t) {
    ...
    }), O.addInitHook("addHandler", "boxZoom", _t), O.mergeOptions({doubleClickZoom: !0}), Ct = o.extend({
        addHooks: function () {
        ...
        addHooks: function () {
            ...
            var e = We(t), i = this._map.options.wheelDebounceTime,
